    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      ...
      <div id="container">                   
            <video id="v_player_trailer" class="video-js vjs-big-play-centered skin-blue vjs-16-9" controls preload="auto" playsinline width="640" height="450" poster="{{URL::to('/'.$movies_info->video_image)}}" data-setup="{}">
                ...
                <source src="{{$movies_info->trailer_url}}" type="video/mp4" label='Auto' res='360'/>
                <source src="{{$movies_info->trailer_url}}" type="video/webm" label='Auto' res='360'/>
                <source src="{{$movies_info->trailer_url}}" type="video/ogg" label='Auto' res='360'/>
